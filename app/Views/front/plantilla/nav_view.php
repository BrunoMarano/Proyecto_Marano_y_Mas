  ...
  <ul class="menu-p">
    ...
    <?php if ($session->get('logged_in')): ?>
      <?php if ($perfil == 1): ?>
        ...
        <li><a class="nav-opciones" href="<?= base_url('altaProducto') ?>">Cargar productos</a></li>
        <li><a class="nav-opciones" href="<?= base_url('crud_usuario') ?>">Crud de Usuario</a></li>
        <li><a class="nav-opciones" href="<?= base_url('') ?>">Muestras Ventas</a></li>
        <li><a class="nav-opciones" href="<?= base_url('') ?>">Consultas</a></li>
      <?php elseif ($perfil == 2): ?>
        <li><a class="nav-opciones" href="<?= base_url('/') ?>">Inicio</a></li>
